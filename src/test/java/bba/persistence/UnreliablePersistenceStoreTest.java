...
class UnreliablePersistenceStoreTest extends DataStoreTest {
    ...
    private UnreliablePersistenceStore legacyStore;

    @BeforeEach
    void setUp() {
        legacyStore = new UnreliablePersistenceStore();
    }

    @Test
    void loadAll_legacy() {
        List<Map<String, Object>> all = legacyStore.loadAll_legacy();
    ...
    void loadByName_legacy(String name) {
        Map<String, Object> retrieved = legacyStore.loadByName_legacy(name);
