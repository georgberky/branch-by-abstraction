...
public class Main {
    ...
    public static void main(String... args) {
        ...
        DataStore store = initializePersistence(System.getenv("PERSISTENCE_IMPLEMENTATION"));
    ...
    private static DataStore initializePersistence(String persistenceImplementation) {
        if("new".equals(persistenceImplementation)) {
